...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/nwhetsell/tree-sitter-lilypond", branch: "main"),
        ...
        .package(url: "https://github.com/tree-sitter-grammars/tree-sitter-objc", from: Version(3, 0, 2)),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "TreeSitterLilyPond", package: "tree-sitter-lilypond"),
